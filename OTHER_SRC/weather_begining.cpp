...
String apiKey = "d864a90e447f3b9d67aaf8c36f221c42";
...
void loop() {
    ...
    if ((millis() - lastTime) > timerDelay) {
        if (WiFi.status() == WL_CONNECTED) {
            ...
            // Examples: https://api.openweathermap.org/data/2.5/weather?q=riverside,ca,usa&units=imperial&appid=d864a90e447f3b9d67aaf8c36f221c42
            //////////////////////////////////////////////////////////////////
            String serverURL = urlOpenWeather + "q=south park,co,usa&units=imperial&appid=" + apiKey;
